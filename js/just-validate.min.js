...
! function () {
  ...
  function (e) {
    ...
    f.prototype = {
      ...
      defaultMessages: { required: "Заполните обязательное поле", email: "Укажите ваш e-mail", maxLength: "The field must contain a maximum of :value characters", minLength: "Как вас зовут?", password: "Password is not valid", remote: "Email already exists", strength: "Password must contents at least one uppercase letter, one lowercase letter and one number", "function": "Укажите ваш телефон" },
